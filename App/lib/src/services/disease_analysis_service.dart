...
class DiseaseAnalysisService {
  ...
  Future<String> saveDetectionByPlantName({
    ...
    return await _db.saveDetectionUsingCatalogByPlantName(
      userId: userId,
      plantName: plantName,
  ...
  Future<String> saveDetectionByPlantId({
    required String userId,
    ...
    return await _db.saveDetectionUsingCatalog(
      userId: userId,
      plantId: plantId,
      detectedLabel: detectedLabel,
      confidence: confidence,
